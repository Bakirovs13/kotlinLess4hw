package kg.geektech.kotlinless4hw.adapters

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import kg.geektech.kotlinless4hw.adapters.RvAdapter.ViewHolder
import kg.geektech.kotlinless4hw.databinding.RvItemBinding

class RvAdapter(private val operationList: MutableList<String>): RecyclerView.Adapter<ViewHolder>() {
